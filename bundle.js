...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(CommentBox, { url: "/api/comment.json", pollInterval: 2000 }), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReactDOM = __webpack_require__(157);
	var CommentList = __webpack_require__(159);
	var CommentForm = __webpack_require__(160);
	    ...
	    loadCommentsFromServer: function loadCommentsFromServer() {
	        $.ajax({
	            ...
	            error: (function (xhr, status, err) {
	                cosnole.error(this.props.url, status, err.toString());
	            }).bind(this)
	        });
	    },
	...
	var CommentForm = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement('input', { type: 'submit', value: 'Poost' })
	        );
	    }
	});
